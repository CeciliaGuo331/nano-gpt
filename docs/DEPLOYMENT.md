...
- **话题惩罚 (Presence Penalty)**: 减少重复话题，-2.0到2.0
- **重复惩罚 (Frequency Penalty)**: 根据词频减少重复，-2.0到2.0
...
| `presence_penalty`  | `float`   | 否       | `0.0`  | 话题重复惩罚，范围：-2.0到2.0               |
| `frequency_penalty` | `float`   | 否       | `0.0`  | 词频重复惩罚，范围：-2.0到2.0               |
