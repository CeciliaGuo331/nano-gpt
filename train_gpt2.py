...
if args.resume or args.auto_resume:
    ...
    if checkpoint_path and os.path.exists(checkpoint_path):
        start_step = load_checkpoint(checkpoint_path, raw_model, optimizer, train_loader, device)
    ...
    if step % 250 == 0 or last_step:
        ...
        if master_process:
            ...
            if step > 0 and (step % args.checkpoint_interval == 0 or last_step):
                ...
                save_checkpoint(step, raw_model, optimizer, train_loader, val_loss_accum.item(), checkpoint_path)
